...
```
Error: ENOENT: no such file or directory, stat 'C:\Users\DELL\OneDrive\Documents\LrnPlaywrightFundamentals\test-data\img.png'
```
            ...
            - generic [ref=e347]:
              ...
              - radiogroup "Profession" [ref=e349]:
                ...
                - generic [ref=e352] [cursor=pointer]:
                  - radio "Automation Tester" [checked] [active] [ref=e353]
...
```ts
  ...
  20 | 
  21 | 
> 22 |     const uploadimg = await page.getByTestId('upload-image').setInputFiles('test-data/img.png');
     |                       ^ Error: ENOENT: no such file or directory, stat 'C:\Users\DELL\OneDrive\Documents\LrnPlaywrightFundamentals\test-data\img.png'
  23 | 
  24 | 
  25 | 
